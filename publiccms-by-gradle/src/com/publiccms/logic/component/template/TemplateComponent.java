...
public class TemplateComponent extends Base implements Cache {
    ...
    private void setFreeMarkerConfigurer(FreeMarkerConfigurer freeMarkerConfigurer,
        ...
        StringBuilder templateDirectives = new StringBuilder();
        for (Entry<String, AbstractTemplateDirective> entry : templateDirectiveMap.entrySet()) {
            ...
            templateDirectives.append(directiveName).append(COMMA_DELIMITED);
        }
        if (0 < templateDirectives.length()) {
            templateDirectives.setLength(templateDirectives.length() - 1);
        }
        ...
        log.info(new StringBuilder().append(templateDirectiveMap.size()).append(" template directives created:[")
                .append(templateDirectives).append("];").toString());
